...
\lstset{inputencoding=utf8, language=Python, backgroundcolor=\color{gray!5}, frame=single,
  rulecolor=\color{gray!50}, basicstyle=\ttfamily\small, keywordstyle=\color{blue!80!black}, commentstyle=\color{green!50!black},
  stringstyle=\color{orange!80!black}, showstringspaces=false, tabsize=4, breaklines=true,
